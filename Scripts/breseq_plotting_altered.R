...
plt_options_dir<- "C:\\Users\\Lewis\\OneDrive - The University of Liverpool\\PhD project - pseudomonas resistance\\Genomics\\increment_increase_evolution\\genome_plots"
setwd(plt_options_dir)
list.files()
...
plotting.options <- read.csv("plotting_options.csv", header = TRUE, na.strings=c(""))
